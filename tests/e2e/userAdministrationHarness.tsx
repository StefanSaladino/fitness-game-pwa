...
let account: PlatformAccountDetail = {
  ...
  username: 'alpha.user.with.a.deliberately.long.username',
  displayName: 'Alpha User With A Deliberately Long Display Name',
  ...
  statusReason: 'Policy review with a deliberately long explanation that must wrap cleanly instead of being clipped by the detail pane.',
