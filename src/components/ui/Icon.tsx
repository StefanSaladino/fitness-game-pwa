...
const paths: Record<IconName, string[]> = {
  ...
  settings: ['M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Z', 'M4.7 9.5 3 8l2-3 2.2.8A8 8 0 0 1 10 4.2L10.5 2h3l.5 2.2a8 8 0 0 1 2.8 1.6L19 5l2 3-1.7 1.5c.2.8.2 1.6 0 2.4L21 13.5l-2 3-2.2-.8A8 8 0 0 1 14 17.8l-.5 2.2h-3l-.5-2.2a8 8 0 0 1-2.8-1.6L5 17l-2-3 1.7-1.5a8 8 0 0 1 0-3Z'],
