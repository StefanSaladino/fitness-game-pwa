...
The project is in **Phase 6: lifting workout capture**. Phase 6.1A provides a durable Start Lift / pause / resume / finish / cancel lifecycle with active-session recovery. Phase 6.1B adds authoritative canonical-exercise composition with persisted ordering. Phase 6.1C / 6.2 adds the real exercise picker: 356 canonical exercises, muscle/workout-type browsing, aliases, typo tolerance, and user-specific recents; set capture follows next.
...
supabase/migrations/20260819000600_workout_session_lifecycle.sql
supabase/migrations/20260819000700_create_group_rpc.sql
supabase/migrations/20260819000800_workout_exercise_composition.sql
supabase/migrations/20260819000900_exercise_picker_catalog.sql
```
...
supabase/tests/011_workout_session_lifecycle.test.sql
supabase/tests/012_create_group_rpc.test.sql
supabase/tests/013_workout_exercise_composition.test.sql
supabase/tests/014_exercise_picker_catalog.test.sql
```
...
src/
  ...
  features/product/     Product-level Home/Workouts/Groups navigation composition
  features/workout/     Active lift, ordered composition, exercise picker/search boundary
